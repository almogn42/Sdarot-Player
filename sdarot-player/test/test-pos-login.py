...
Pervios_Tab = driver.window_handles[2]
...
driver.get(r"https://www.sdarot.tw/watch/203/season/1/episode/2")
# time.sleep(34)
...
#opening in new tab the Ep
driver.get(r"https://www.sdarot.tw/watch/203/season/1/episode/3")
# time.sleep(34)
...
driver.close()
#switching to New tab
driver.switch_to.window(Pervios_Tab)
#opening in new tab the Ep
driver.get(r"https://www.sdarot.tw/watch/203/season/1/episode/1")
